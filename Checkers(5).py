...
# meta name: Шашки
# meta version: 1.0.9 # Увеличим версию, так как внесены изменения
#
...
PIECE_EMOJIS = {
    EMPTY: "▪️", # Темная пустая клетка
    "light": "▫️", # Светлая пустая клетка
    WHITE_MAN: "⚪",
    BLACK_MAN: "⚫",
    WHITE_KING: "👑", # Изменено на более универсальную корону
    BLACK_KING: "♟️", # Изменено на более универсальную черную корону/фигуру короля
    'selected': "🔘",
    'move_target': "🟢",
    'capture_target': "🔴",
}
